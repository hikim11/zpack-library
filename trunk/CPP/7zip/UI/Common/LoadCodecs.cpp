...
static void *CreateCodec2() { return (void *)(ICompressCoder *)(new NCompress::NLzma2::CDecoder); }
#ifndef EXTRACT_ONLY
#include "Lzma2Encoder.h"
static void *CreateCodecOut2() { return (void *)(ICompressCoder *)(new NCompress::NLzma2::CEncoder);  }
#else
#define CreateCodecOut2 0
#endif

#include "CopyCoder.h"

static void *CreateCopyCodec() { return (void *)(ICompressCoder *)(new NCompress::CCopyCoder); }
...
/*
static void *CreateAesCodec() { return (void *)(ICompressCoder *)(new NCompress::NAes::CCoder ); }

static void *CreateAesCodeOut() { return (void *)(ICompressCoder *)(new NCompress::NAes::CCoder ); }

static CCodecInfo g_CodecInfo =
{ CreateCodec, CreateCodecOut, 0x030101, L"LZMA", 1, false };

static CCodecInfo g_AesCodeInfo =
{ CreateAesCodec, CreateAesCodec, 0x06F10701, L"AES", 1, false };
...
struct REGISTER_CODEC_NAME(AES) {
	REGISTER_CODEC_NAME(AES)() { RegisterCodec(&g_AesCodeInfo); } };

	static CRegisterCodecAES g_RegisterAESCodec;
	*/
...
HRESULT CCodecs::Load()
{
  ...
  //static CCodecInfo g_AesCodeInfo =
  //{ CreateAesCodec, CreateAesCodeOut, 0x06F10701, L"AES", 1, false };
  ...
  static CCodecInfo g_CodecInfo2 =
  { CreateCodec2, CreateCodecOut2, 0x21, L"LZMA2", 1, false };

  struct REGISTER_CODEC_NAME(LZMA2) {
	  REGISTER_CODEC_NAME(LZMA2)() { RegisterCodec(&g_CodecInfo2); } };

  static CRegisterCodecLZMA2 g_RegisterLZMA2Codec;

  static CCodecInfo g_CopyCodecInfo =
  { CreateCopyCodec, CreateCopyCodec, 0x00, L"Copy", 1, false };

  struct REGISTER_CODEC_NAME(Copy) {
	  REGISTER_CODEC_NAME(Copy)() { RegisterCodec(&g_CopyCodecInfo); } };

  static CRegisterCodecCopy g_RegisterCopyCodec;

  static BcjCodecRegister::Register bcjRegister;

  static Bcj2CodecRegister::Register bcj2Register;
