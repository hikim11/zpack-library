...
template<typename R>
inline R lexical_cast( std::string & t )
{
	return lexical_cast<R>(t.c_str());
}

template<>
inline std::string lexical_cast( std::string & t )
{
	return t;
}
...
template<typename R>
inline R lexical_cast( std::wstring & t )
{
	return lexical_cast<R>(t.c_str());
}

template<>
inline std::wstring lexical_cast( std::wstring & t )
{
	return t;
}
