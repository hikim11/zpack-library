...
STDMETHODIMP CHandler::Open(IInStream *stream,
    ...
    IArchiveOpenCallback *openArchiveCallback, ZDB * zdb)
{
  COM_TRY_BEGIN
  Close();
  #ifndef _SFX
  ...
  try
  {
	...
	//CMyComPtr<ICryptoGetTextPassword> getTextPassword( new CCryptoGetTextPassword );
    #endif
    CInArchive archive;
...
static void *CreateAesCodec() { return (void *)(ICompressFilter *)(new NCrypto::NSevenZ::CDecoder()); }
#ifndef EXTRACT_ONLY
static void *CreateAesCodecOut() { return (void *)(ICompressFilter *)(new NCrypto::NSevenZ::CEncoder()); }
#else
#define CreateCodecOut 0
#endif

static CCodecInfo g_AesCodecInfo =
{ CreateAesCodec, CreateAesCodecOut, 0x06F10701, L"7zAES", 1, true };

struct REGISTER_CODEC_NAME(7zAES) {
	REGISTER_CODEC_NAME(7zAES)() { RegisterCodec(&g_AesCodecInfo); } };

static CRegisterCodec7zAES g_RegisterAESCodec;
...
static CAesTabInit g_AesTabInit;